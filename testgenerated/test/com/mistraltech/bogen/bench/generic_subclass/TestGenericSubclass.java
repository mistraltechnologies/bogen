...
import static com.mistraltech.bogen.bench.generic_subclass.SubWidgetBBuilder.aSubWidgetBFrom;
...
public class TestGenericSubclass {
    @Test
    public void test() {
        SubWidgetB<String> subWidgetB = com.mistraltech.bogen.bench.generic_subclass.SubWidgetBBuilder.<String>aSubWidgetB()
                .withProp1("prop1")
                .withProp2("prop2")
                .withProp3("prop3")
                .withProp4("prop4")
    ...
    public void testWithDefaults() {
        com.mistraltech.bogen.bench.generic_subclass.SubWidgetBBuilder<String> subWidgetBBuilder = SubWidgetBBuilder.aSubWidgetB();
